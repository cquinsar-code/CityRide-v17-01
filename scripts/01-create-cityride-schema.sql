...
-- RLS Policies (allow public access for now, will be restricted with auth)
...
CREATE POLICY "Allow all access to taxi_locations" ON taxi_locations FOR ALL USING (true);
CREATE POLICY "Allow all access to password_reset_requests" ON password_reset_requests FOR ALL USING (true);
CREATE POLICY "Allow all access to suggestions" ON suggestions FOR ALL USING (true);
CREATE POLICY "Allow all access to deleted_reservations" ON deleted_reservations FOR ALL USING (true);
