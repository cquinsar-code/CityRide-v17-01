...
export async function POST(request: NextRequest): Promise<NextResponse<ReverseGeocodeResult | { error: string }>> {
  try {
    ...
    return NextResponse.json({ address: "Ubicación desconocida", formatted: "Ubicación desconocida" })
  } catch (error) {
